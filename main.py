...
class Tasks(Resource):
	...
	def get(self):
		...
		tasks_list = Task.query.order_by(Task.id_task).filter_by(id_user = identity["id_user"], active=True)
		retorno = []
...
class get_history(Resource):
	...
	def get(self):
		...
		tasks_list = Task.query.order_by(Task.id_task.desc()).filter_by(id_user=identity["id_user"], active=False)
		retorno = []
		for task in tasks_list:
